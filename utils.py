...
def generate_data(targ_size: tuple[int, int], batch_size: int) -> ImageDataGenerator:
    ...
    train_datagen = ImageDataGenerator(
        ...
        #rotation_range=0.05, # Random rotations of 10 degree 
        #width_shift_range=0.05, # Randomly Shift pixels between 0% and 5% in width
        #height_shift_range=0.05, # Randomly shift pixels between 0% and 5% in height
        #shear_range=0.05, # Shear angle in counter-clockwise direction in degrees
        #zoom_range=0.05, # Zoom in between 0 and 20 %
